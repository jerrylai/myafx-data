...
public class MonthTypeHandler extends BaseTypeHandler<Month> {
  ...
  @Override
  public void setParameter(PreparedStatement ps, int i, Object month) throws SQLException {
    if(month == null) ps.setNull(i, Types.INTEGER);
    else ps.setInt(i, ((Month)month).getValue());
  }
